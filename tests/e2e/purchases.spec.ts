...
test.describe('Purchases & Inward Stock E2E Suite', () => {
  ...
  test('should navigate to Purchases tab and display inward invoices list', async () => {
    const purchasesTab = window.locator('button', { hasText: 'Purchases' })
